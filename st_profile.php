...
include 'db.php';
$q=mysqli_query($con,"select s_name from t_user_data where s_id='".$user."'");


$result = mysqli_query($con,"SELECT * FROM t_user WHERE s_id='".$user."'");
if (mysqli_num_rows($result) == 1) {
    $n=  mysqli_fetch_assoc($q);
}
elseif (mysqli_num_rows($result) == 0) {
    echo  "This student didn't completed the admission process";
    exit();
}
$stname= $n['s_name'];
...
<html>
    ...
    <body>
      ...
      <center>  <table class="table table-bordered" style="font-family: Verdana">
                ...
                <tr>
                 <td style="width:3%; padding-bottom:20px;padding-left:20px;"><br><br><img src="./images/logow.png" width="90%" > </td>
                 <td style="width:8%;"><center><font style="font-family:Arial Black; font-size:30px;">
                     <br><br>
                    Aligarh Muslim University, Aligarh - 202002</font></center>
                ...
                <center><font style="font-family:Arial Black; font-size:20px;">
                    ADMISSIONS (2023-24)</font></center>
                </td>
                   ...
                   <?php
                    ...
                    while($row1 = mysqli_fetch_array($result1))
                      {                  
                        ...
                        echo "<img src='$picsrc' class='img-thumbnail' width='330px' style='height:280px;'>";
                        echo"<div>";
                      }
                      
                      
                        $resdata = mysqli_query($con,"SELECT * FROM t_user_data WHERE s_id='".$user."'");
        ...
        ?>
            <center> <h3 ><a href="st_profile_doc.php?username=<?php echo $user;?>" class="w3-button w3-blue">Documents</a></center></h3>
            <br><br> <br>
    </body>
</html>
