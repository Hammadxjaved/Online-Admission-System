...
if(isset($_REQUEST["in_sub"]))
{
  ...
  {
      $con = mysqli_connect("localhost", "root", "", "oas");
      $rs  = mysqli_query($con,"select CONCAT('ABC',LPAD(RIGHT(ifnull(max(s_id),'ABC00000'),5) + 1,5,'0')) from t_user_data");
...
<html>
    ...
    <body style="background-image:url('./images/inbg.jpg'); height:fit-content; width:fit-content">
        <form id="signupconfirm" action="signupconfirm.php" method="post">
            ...
            <!-- <div class="container-fluid">     -->
                <div class="row">
                  <div class="col-sm-12">
                        <img src="images/toplogo.png" width="95%" height="80px" style="box-shadow: 1px 5px 14px #999999; "></img>
                  </div>
                 </div>    
             <!-- </div> -->
        <div id="dmid">
        ...
        <div id="ddown">
            <br><br><br>
             <div id="drig" style="text-align: center;">
                 <br><br>
                 <center><font style="color: #3399ff; margin-left:30px; font-family: Verdana;font-size:30px;">
                     <?php  //require_once("mail-content.php");  ?>
                     
                      <?php echo "Your User ID is $stid and Password is $stpw" ; ?><br>
                    You are successfully registered. </font></center>
                 <br><br>
            
                 <input type="submit" id="u_sub" name="u_sub" value="Login" class="toggle btn btn-primary" style="width:100px; "><br><br>
             </div>
        </div>
